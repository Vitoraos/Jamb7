...
const queryEmbedding = embeddingData[0];
    ...
    const systemPrompt = "You are an elite JAMB tutor and exam strategist. Your goal is to help a student score 380+ in JAMB in the next 40 days. You have access to a semantic search engine containing past questions in Physics, Chemistry, and Mathematics. Instructions
